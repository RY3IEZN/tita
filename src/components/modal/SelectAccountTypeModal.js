...
import SelectAccountType from "../../pages/components/SelectAccountType";
// import AppText from "./src/pages/components/AppText";
// import appcolors from "../../config/appcolors";
// import AppText from "../page/AppText";

const SelectAccountTypeModal = ({
            ...
            <View style={styles.modalContainer}>
              ...
              <View style={{ marginTop: 32 }}>
                <SelectAccountType
                  ...
                  accountnumber={"1234xxxx"}
                  checkboxed
                  onPress={() => handModalItemPress("savings")}
                />
                <SelectAccountType
                  ...
                  accountnumber={"1234xxxx"}
                  checkboxed
                  onPress={() => handModalItemPress("titawallet")}
                />
                <SelectAccountType
                  ...
                  accountnumber={"1234xxxx"}
                  checkboxed
                  onPress={() => handModalItemPress("business")}
                />
              </View>
